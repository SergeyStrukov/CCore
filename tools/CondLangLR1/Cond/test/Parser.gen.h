...
enum RIndex { RIndexShift=0, RIndexLim=14 };

const char * GetTextDesc(RIndex);

enum RuleLength { RuleLengthZero=0, RuleLengthMax=3 };

enum TIndex { TIndexEnd=0, TIndexLim=13 };

const char * GetTextDesc(TIndex);

enum NTIndex { NTIndexEnd=0, NTIndexLim=17 };

const char * GetTextDesc(NTIndex);

enum StateIndex { StateIndexBegin=0, StateIndexLim=52 };
