...
struct IntegerFastAlgo
 {
  ...
  static Unit RawUMac(Unit *restrict c,const Unit *a,ulen na,const Unit *b,ulen nb,Unit carry=0) noexcept; // nb>=na>=2, nc==na+nb
  
  static Unit RawUMac1(Unit *restrict c,Unit a,const Unit *b,ulen nb,Unit carry=0) noexcept; // nb>=2, nc==1+nb
  
  static Unit RawUMac11(Unit *c,Unit a,Unit b,Unit carry=0) noexcept; // nc==2
