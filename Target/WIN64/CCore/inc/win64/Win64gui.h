...
int WIN64_API GetSystemMetrics(unsigned sys_metric);
...
bool_t WIN64_API TranslateAcceleratorA(HWindow hWnd,HAccelerator hAccel,Msg *msg);
...
bool_t WIN64_API ShowWindow(HWindow hWnd,unsigned cmd_show);
...
bool_t WIN64_API MoveWindow(HWindow hWnd,int x,int y,int dx,int dy,bool_t repaint);

bool_t WIN64_API SetWindowPos(HWindow hWnd,HWindow ins_after,int x,int y,int dx,int dy,unsigned pos_flags);

HCursor WIN64_API SetCursor(HCursor hCursor);

bool_t WIN64_API TrackMouseEvent(TrackMouseDesc *track);

HBrush WIN64_API GetSysColorBrush(unsigned sys_color_index);
...
HWindow WIN64_API CreateWindowExA(unsigned ex_window_style,
                                  const char *class_name,
                                  const char *window_name,
                                  unsigned window_style,
...
UPtrType WIN64_API DialogBoxParamA(HModule hModule,
                                   const char *res,
                                   HWindow hParent,
                                   DialogProc dialog_proc,
                                   MsgLParam lParam);

int WIN64_API MessageBoxA(HWindow hParent,
                          const char *text,
                          const char *caption,
                          unsigned message_box_flags);

bool_t WIN64_API EndDialog(HWindow hWnd,UPtrType result);

HWindow WIN64_API GetDlgItem(HWindow hWnd,int dialogitem_id);

bool_t WIN64_API GdiFlush(void);

HPen WIN64_API CreatePen(unsigned pen_style,int width,Color32 color);

HBrush WIN64_API CreateSolidBrush(Color32 color);

HFont WIN64_API CreateFontA(int dy,
                            int dx,
                            int escapement,
                            int orientation,
                            unsigned weight,
...
unsigned WIN64_API SetBkMode(HGDevice hGD,unsigned bk_mode);

unsigned WIN64_API SetTextAlign(HGDevice hGD,unsigned text_align_flags);

Color32 WIN64_API SetTextColor(HGDevice hGD,Color32 color);

bool_t WIN64_API MoveToEx(HGDevice hGD,
                          int x,int y,
                          Point *prev);

bool_t WIN64_API LineTo(HGDevice hGD,
                        int x,int y);

bool_t WIN64_API PatBlt(HGDevice hGD,
                        int x,int y,int dx,int dy,
                        unsigned pat_op);

bool_t WIN64_API BeginPath(HGDevice hGD);

bool_t WIN64_API EndPath(HGDevice hGD);

bool_t WIN64_API CloseFigure(HGDevice hGD);

bool_t WIN64_API StrokePath(HGDevice hGD);

bool_t WIN64_API FillPath(HGDevice hGD);

bool_t WIN64_API StrokeAndFillPath(HGDevice hGD);

bool_t WIN64_API TextOutA(HGDevice hGD,
                          int x,int y,
                          const char *str,int len);

bool_t WIN64_API GetTextExtentPoint32A(HGDevice hGD,
                                       const char *str,int len,
                                       Size *size);

unsigned WIN64_API GetCharacterPlacementA(HGDevice hGD,
                                          const char *str,int len,
                                          int max_extent,
                                          CharPlacement *result,
                                          unsigned flags);

bool_t WIN64_API ExtTextOutA(HGDevice hGD,
                             int x,int y,
                             unsigned options,
...
bool_t WIN64_API SystemParametersInfoA(unsigned action,
                                       unsigned param,
                                       void *data,
