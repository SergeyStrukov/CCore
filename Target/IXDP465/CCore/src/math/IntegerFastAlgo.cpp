...
struct IntegerFastAlgo::DefAlgo1 : DefAlgoBase
 {
  ...
  static const unsigned D1 = 6 ;
  
  static const unsigned D2 = 6 ;
...
struct IntegerFastAlgo::KAlgo
 {
  ...
  static const unsigned D1 = 4 ;
  
  static const unsigned D2 = 4 ;
...
struct IntegerFastAlgo::DefAlgo2 : DefAlgoBase
 {
  ...
  static const unsigned D1 = 16 ;
  
  static const unsigned D2 = 16 ;
...
unsigned IntegerFastAlgo::CountZeroLSB(Unit a) noexcept
 {
  ...
  if( !(a&0xFFFF) ) ret+=16,a>>=16;
  if( !(a&0x00FF) ) ret+= 8,a>>= 8;
...
Unit IntegerFastAlgo::RawUMac(Unit *restrict c,const Unit *a,ulen na,const Unit *b,ulen nb) noexcept
 {
  return Slow::UMac(c,a,na,b,nb);
 }

Unit IntegerFastAlgo::RawUMac1(Unit *restrict c,Unit a,const Unit *b,ulen nb) noexcept
 {
  return Slow::UMac(c,&a,1,b,nb);
 }

Unit IntegerFastAlgo::RawUMac11(Unit *c,Unit a,Unit b) noexcept
 {
  return Slow::UMac(c,&a,1,&b,1);
 }
